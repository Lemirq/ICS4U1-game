...
public class Images {
    ...
    public static BufferedImage player_idle, circle, gun, bullet, tree, shop;
    ...
    public static void loadImages() {
        try {
            ...
            for (int i = 1; i <= 12; i++) {
                player_running
                        .add(ImageIO.read(Images.class.getResource("/sprites/player_running/cropped/r" + i + ".png")));
            }
            ...
            tree = ImageIO.read(Images.class.getResource("/tree/200x200.png"));
            shop = ImageIO.read(Images.class.getResource("/buildings/shop2.png"));
