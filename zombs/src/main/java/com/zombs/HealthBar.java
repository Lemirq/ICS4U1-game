...
public class HealthBar {
    ...
    private static final int roundRectArc = 20;
    ...
    public void draw(Graphics2D g2d) {
        ...
        int X_POSITION = 200;
        int Y_POSITION = (GamePanel.screenHeight * 2) - 200;
        ...
        g2d.drawString(String.valueOf(healthValue), X_POSITION + BAR_WIDTH + 12, Y_POSITION + BAR_HEIGHT - 10);
